const CACHE='catalogo-shell-v3';
const SHELL=['./','./index.html','./styles.css','./app.js','./produtos.js','./manifest.webmanifest','./assets/logos/acreaves.png','./assets/logos/dom-porquito.png','./assets/logos/fripal.jpg'];
